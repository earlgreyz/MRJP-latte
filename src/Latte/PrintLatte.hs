...
instance {-# OVERLAPS #-} Print Integer where
  prt _ x = doc (shows x)

instance {-# OVERLAPS #-} Print Double where
  prt _ x = doc (shows x)

instance {-# OVERLAPS #-} Print Ident where
  prt _ (Ident i) = doc (showString i)

instance {-# OVERLAPS #-} Print Program where
  prt i e = case e of
    Program topdefs -> prPrec i 0 (concatD [prt 0 topdefs])

instance {-# OVERLAPS #-} Print TopDef where
  prt i e = case e of
...
instance {-# OVERLAPS #-} Print Arg where
  prt i e = case e of
...
instance {-# OVERLAPS #-} Print Item where
  prt i e = case e of
...
instance {-# OVERLAPS #-} Print Type where
  prt i e = case e of
...
instance {-# OVERLAPS #-} Print Expr where
  prt i e = case e of
